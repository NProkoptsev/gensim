...
# Test dataset
contents_test = [paper(words=['machine', 'learning', 'deep', 'learning', 'neural', 'network', 'convolution'], tags=['1']),
    paper(words=['neural', 'network', 'statistics', 'score', 'regression', 'backpropagation'], tags=['2']),
    paper(words=['machine', 'learning', 'deep', 'learning', 'neural', 'network', 'convolution'], tags=['3']),
    paper(words=['genetic', 'algorithms', 'epoch', 'score', 'changing', 'biological'], tags=['4']),
    paper(words=['neural', 'network', 'backpropagation', 'feedforward', 'regression', 'overfitting', 'autoencoder'], tags=['5']),
    paper(words=['reinforcement', 'learning', 'training', 'states', 'regression'], tags=['6'])]
citation_test = [(1, 5), (1, 2), (2, 3), (3, 6), (4, 6)]
